          ...
          <div>
            <Card className='p-2'>
              ...
              <Row>
                {/* <Col md={3}>
                  ...
                  >
                    ...
                    <option value="1">Sri Vinayaka Jewellers, Bengalore</option>
                    <option value="2">Sri Vinayaka Jewellers, Chennai</option>
                    <option value="3">Sri Vinayaka Jewellers, Mumbai</option>
                    <option value="4">Sri Vinayaka Jewellers, JP Nagar</option>
                    <option value="5">Sri Vinayaka Jewellers, Jay Nagar</option>
                    <option value="6">Sri Vinayaka Jewellers, Delhi</option>
                    <option value="7">Sri Vinayaka Jewellers, Hyderabad</option>
                  </Form.Select>
                </Col> */}
                <Col md={3}>
                  <Form.Select
              ...
              {/* <Row>
                {selection == 1 &&
                  <Col md={3}>
                    <Button variant="warning" onClick={handleShowModal}>Add new Physical Gold</Button>
                  </Col>
                }
                {selection == 2 &&
                  <Col md={3}>
                    <Button variant="warning" onClick={handleShowModal1}>Add new Physical Gold</Button>
                  </Col>
                }
              </Row> */}
              <hr />
